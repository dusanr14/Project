...
HD_PWD='C:/Users/Dusan/Desktop/projekat_radi/divider/pivot/pivot.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pivot_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pivot_wrapper.tcl
