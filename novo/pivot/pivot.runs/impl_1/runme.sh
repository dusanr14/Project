...
HD_PWD='C:/Users/Dusan/Desktop/projekat_radi/divider/pivot/pivot.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pivot_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pivot_wrapper.tcl -notrace
