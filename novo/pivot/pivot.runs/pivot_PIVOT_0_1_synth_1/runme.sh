...
HD_PWD='C:/Users/Dusan/Desktop/projekat_radi/divider/pivot/pivot.runs/pivot_PIVOT_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pivot_PIVOT_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pivot_PIVOT_0_1.tcl
